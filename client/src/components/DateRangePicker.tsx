    ...
    useEffect(() => {
        if (pickupDate && pickupTime) {
            ...
            setFilters((prevFilters: any) => ({
                ...prevFilters,
                availabilityFrom: pickupDateTime.toDate(),
            }));
        }
    }, [pickupDate, pickupTime, setFilters]);


    useEffect(() => {
        if (dropoffDate && dropoffTime) {
            const dropoffDateTime = dropoffDate.hour(dropoffTime.hour()).minute(dropoffTime.minute());
            setFilters((prevFilters: any) => ({
                ...prevFilters,
                availabilityTo: dropoffDateTime.toDate(),
            }));
        }
    }, [dropoffDate, dropoffTime, setFilters]);
